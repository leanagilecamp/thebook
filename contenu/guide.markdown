...
- elle est prometteuse : Le bénéfice attendu important. Ce bénéfice est
...
Deux binômes qui réalisent des taches qui se chevauchent.

Réaliser une tâche inutile.

Effectuer un travail inefficace.
...
Report entre branches d’un gestionnaire de configuration.
...
visés sont atteints. Sinon il est KO.
...
Que le Check soit OK ou KO, il y a toujours quelque chose à apprendre
