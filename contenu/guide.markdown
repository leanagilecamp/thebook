...
terrain (le *gemba*[^2^](#sdfootnote2sym), en termes lean), pour voir
comment travaille un praticien.
...
visite terrain[^4^](#sdfootnote4sym) avant de s'emballer.
...
environ deux signalisations[^5^](#sdfootnote5sym) par jour de nos
...
![](guide_html_md963eae.png)

*Tableau kanban*

![](guide_html_m281c5d9e.png)
...
problème[^9^](#sdfootnote9sym) (exemple : plainte client car le service
...
![](guide_html_35bf1a8a.png)

*Structure de notre management visuel*

![du\_rififi\_dans\_mes\_sprints\_suivi\_pbs](guide_html_edd7b90.jpg)
...
Ce challenge[^11^](#sdfootnote11sym) se traduit tout d'abord par
...
production[^12^](#sdfootnote12sym), puis représente son activité sous la
forme d’un tableau visuel.
...
La cause racine[^14^](#sdfootnote14sym) du problème se trouve dans la
...
Tout d’abord, l'équipe enrichit son management visuel, en rendant
visibles, pour chaque tâche, les obstacles (questions bloquantes en
cours) sous la forme de *post-its* rouges :

![](guide_html_4d612878.png)
...
Nous rencontrons un problème[^16^](#sdfootnote16sym) de tenue des délais
qui se matérialise sprint après sprint par un reste à faire de 10 à 20%
en fin de sprint :
...
![](guide_html_m38e7ce62.png)

*Suivi du « reste à faire » en fin d’itération*
...
![reste\_fin\_iteration\_couleurs](guide_html_308de9ef.png)
...
![comprendreVoirAgir](guide_html_194642db.png)
...
*. ![20100723-REX-ACE-PAT002 Performance
(small)](guide_html_72ddbd8.jpg)*
...
l’esprit des "5 pourquoi" du lean[^18^](#sdfootnote18sym) pour éviter la
...
ajoutons un *andon*[^21^](#sdfootnote21sym).

![](guide_html_6b377e88.png)
...
ponctuelle perturbe les sprints en cours.[^22^](#sdfootnote22sym)
...
utilisant la technique des "**5 pourquoi**"[^23^](#sdfootnote23sym).
...
![dev\_40\_pourcents\_seul](guide_html_m5c28feb3.jpg)
...
« aller sur le *gemba* »[^25^](#sdfootnote25sym). Elle répond aux
questions « A quelle étape, et à quel endroit, le problème
survient-il ? » et « Quel est le potentiel d’amélioration ? ».

![dev\_40\_pourcents\_seul](guide_html_72d67483.jpg)
...
gaspillages[^26^](#sdfootnote26sym), c’est-à-dire 7 façons différentes
...
[2](#sdfootnote2anc)^^ Le « *gemba »* désigne l’endroit où les choses
se passent. Cf. la section « Principe lean » de ce chapitre.

[3](#sdfootnote3anc)^^ La voix du client  est une pratique lean qui
permet de capturer les attentes du client. Cf. la section « Principe
lean » de ce chapitre

[4](#sdfootnote4anc)^^ La visite terrain se réfère à une pratique lean
le go & see pour se forger ses propres opinions sur le contexte et les
attentes du client. Cf. la section « Principe lean » de ce chapitre.

[5](#sdfootnote5anc) Nous appelons signalisation un incident remonté
par l'utilisateur.

[6](#sdfootnote6anc)^^ Attention toutefois sur ce dernier point :
l’équipe doit rester vigilante à ne pas asservir l’humain à la machine.
La vision lean considère la technologie comme un outil mis au service de
l’intelligence humaine.

[7](#sdfootnote7anc)^^ Voir le chapitre « De "L'amélioration continue"
à "Trouver les leviers de l'amélioration" ».
...
[12](#sdfootnote12anc) Cf. Section « Principes Lean » de ce chapitre

[13](#sdfootnote13anc) Une amélioration possible consisterait à
...
[14](#sdfootnote14anc) Cf. Section « Principes Lean » du chapitre « Les
leviers de l’amélioration »

[15](#sdfootnote15anc) Cf. Section « Principes Lean » de ce chapitre

[16](#sdfootnote16anc) Cf. Section « Principes Lean » du chapitre
« Leviers de l’amélioration »

[17](#sdfootnote17anc) Cf. Section « Principes Lean » du chapitre
« Attentes du client»

[18](#sdfootnote18anc) Les 5 pourquoi du lean : Cf. la section
« Principe lean » du chapitre « Trouver les leviers de l’amélioration ».

[19](#sdfootnote19anc) Cause profonde en lean : Cf. la section
« Principe lean » du chapitre « Trouver les leviers de l’amélioration ».

[20](#sdfootnote20anc) l’arbre de cause : l’enchaînement cause et
conséquence est représenté sous forme arborescente. Cf : la section
« Principe lean » du chapitre « Trouver les leviers de l’amélioration ».

[21](#sdfootnote21anc) Le andon désigne une alerte lumineuse pour
signaler tout dysfonctionnement au plus tôt et s’accompagne d’un arrêt
immédiat. Dans le cas des machines et des outils, l’allumage du andon
est automatique en cas d’anomalie. En informatique, cela évoque le
concept du Fail-Fast (cf
[http://martinfowler.com/ieeeSoftware/failFast.pdf](http://martinfowler.com/ieeeSoftware/failFast.pdf)).

[22](#sdfootnote22anc) Cette situation est également décrite dans le
chapitre "Management Visuel/Maintenance d’un site e-commerce dans la
grande distribution"

[23](#sdfootnote23anc) Les 5 pourquoi du lean : Cf. la section
« Principe lean » du chapitre « Trouver les leviers de l’amélioration ».

[24](#sdfootnote24anc) Une épique est un ensemble fonctionnel cohérent
de User Stories.

[25](#sdfootnote25anc) Le chapitre « De Satisfaire le client à
Comprendre son attente » présente aussi cette pratique, mais dans le
périmètre restreint du client.

[26](#sdfootnote26anc) Le chapitre « Client » introduit la notion de
